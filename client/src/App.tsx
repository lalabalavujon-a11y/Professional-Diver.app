...
import TestimonialsSubmit from "@/pages/testimonials-submit";
import { useReferral } from "@/hooks/use-referral";
import { setupReferralDebug } from "@/utils/referral-debug";
...
function Router() {
  ...
  // Capture referral codes on all pages
  useReferral();
  
  // Setup debug utility in development
  if (typeof window !== 'undefined' && (import.meta.env.DEV || window.location.hostname.includes('localhost'))) {
    setupReferralDebug();
  }
  return (
    <Switch>
