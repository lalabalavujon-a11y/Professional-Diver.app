...
import { CheckCircle, Clock, BookOpen, Brain, BarChart3, Mic, ChevronRight, Star, Users, Trophy, Shield, LogIn, Home } from "lucide-react";
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500">Exam Preparation & Training</div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 mb-6 leading-relaxed">
              <strong className="text-slate-900">Brand-neutral exam preparation platform</strong> with comprehensive practice tests, AI-powered tutors, 
              timed mock exams, and adaptive learning to prepare you for professional certification exams from accredited certification bodies.
            </p>
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
              <div className="flex items-start">
                <Shield className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="text-sm font-semibold text-blue-900 mb-2">Exam Preparation Only - Brand Neutral</p>
                  <p className="text-sm text-blue-800">
                    We provide comprehensive preparation materials to help you succeed on professional certification exams. 
                    <strong className="text-blue-900"> We do not issue certifications.</strong> Certifications are issued separately 
                    by accredited certification bodies and diving schools. Our platform is brand-neutral and prepares you for 
                    exams from various recognized certification organizations.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Brand-neutral preparation for professional certification exams. From NDT inspection to emergency medical response, 
              prepare for commercial diving certification exams from accredited certification bodies with our comprehensive practice platform.
            </p>
          </div>
