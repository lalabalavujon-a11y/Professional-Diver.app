        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-semibold text-slate-900 text-sm sm:text-base">Diver Well Training</span>
            </div>
            <div className="flex items-center flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-slate-500">
              <a href="#" className="hover:text-slate-700 min-h-[44px] flex items-center">Privacy Policy</a>
              <a href="#" className="hover:text-slate-700 min-h-[44px] flex items-center">Terms of Service</a>
              <a href="#" className="hover:text-slate-700 min-h-[44px] flex items-center">Support</a>
            </div>
          </div>
        </div>
      </footer>
