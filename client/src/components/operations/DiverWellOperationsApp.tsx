/**
 * Diver Well Operations App - Embedded Chat Interface
 * 
 * Embedded version of Diver Well AI Consultant for use within Operations page.
 * Provides commercial diving operations AI consultation with chat and voice capabilities.
 */
...
import { Send, Volume2, VolumeX, Pause, Mic, MicOff, Waves } from "lucide-react";
...
export default function DiverWellOperationsApp() {
