...
const examMetadata = {
  ...
  'saturation-diving': {
    ...
    title: 'Saturation Diving Systems - Professional Exam',
    description: 'Advanced saturation diving examination covering life support systems, bell operations, gas management, emergency response, and saturation decompression practices.',
    timeLimit: 135,
    passingScore: 85,
    maxAttempts: 3,
  },
  ...
  'commercial-air-diver-wet-bell': {
    ...
    title: 'Commercial Air Diver + Top Up (Wet Bell) - Professional Exam',
    description: 'Professional air diver examination covering surface-supplied air operations, wet bell procedures, gas management, communication protocols, and emergency response.',
    timeLimit: 120,
    passingScore: 80,
    maxAttempts: 3,
  },
